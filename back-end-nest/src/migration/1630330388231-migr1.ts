...
export class migr11630330388231 implements MigrationInterface {
    name = 'migr11630330388231'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "friend" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" integer NOT NULL, "connectorId" uuid, "friendId" uuid, CONSTRAINT "UQ_41f7529202af9580455d443f5e1" UNIQUE ("connectorId", "friendId"), CONSTRAINT "PK_1b301ac8ac5fcee876db96069b6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "friend" ADD CONSTRAINT "FK_b1ce62bb6087dfeaac978930554" FOREIGN KEY ("connectorId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "friend" DROP CONSTRAINT "FK_b1ce62bb6087dfeaac978930554"`);
