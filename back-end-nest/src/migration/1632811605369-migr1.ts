...
export class migr11632811605369 implements MigrationInterface {
    name = 'migr11632811605369'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "message" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createDateTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "content" character varying NOT NULL, "button" boolean NOT NULL DEFAULT false, "duelId" character varying, "authorId" uuid, CONSTRAINT "PK_ba01f0a3e0123651915008bc578" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "duel" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" integer NOT NULL, "gameId" character varying, "duelOwnerId" uuid, "duelId" uuid, CONSTRAINT "UQ_5a11e41a5458c0c51fb46d56ed3" UNIQUE ("duelOwnerId", "duelId"), CONSTRAINT "PK_1575a4255b3bdf1f11398841d0d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "queue" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "queueTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "gameId" character varying, "queuerId" uuid, CONSTRAINT "PK_4adefbd9c73b3f9a49985a5529f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "game" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "startTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "pointToVictory" integer NOT NULL, "ballSize" integer NOT NULL, "ballSpeed" integer NOT NULL, "status" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_352a30652cd352f552fef73dec5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "isFortyTwoAccount" boolean NOT NULL DEFAULT false, "twoFactorAuthenticationSecret" character varying, "isTwoFactorAuthenticationEnabled" boolean NOT NULL DEFAULT false, "avatar" character varying NOT NULL DEFAULT 'http://localhost:3000/user/avatar/default.png', "status" integer NOT NULL DEFAULT '0', "level" integer NOT NULL DEFAULT '0', "nGames" integer NOT NULL DEFAULT '0', "nWins" integer NOT NULL DEFAULT '0', "nLosses" integer NOT NULL DEFAULT '0', "xp" integer NOT NULL DEFAULT '0', "admin" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_065d4d8f3b5adb4a08841eae3c8" UNIQUE ("name"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
