...
export class migr11631015252782 implements MigrationInterface {
    name = 'migr11631015252782'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "participant" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "authorized" boolean NOT NULL DEFAULT false, "admin" boolean NOT NULL DEFAULT false, "mute" boolean NOT NULL DEFAULT false, "muteEndDateTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "ban" boolean NOT NULL DEFAULT false, "banEndDateTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid, "channelId" uuid, CONSTRAINT "UQ_e680caf2e9903f9647eff3c04f6" UNIQUE ("userId", "channelId"), CONSTRAINT "PK_64da4237f502041781ca15d4c41" PRIMARY KEY ("id"))`);
