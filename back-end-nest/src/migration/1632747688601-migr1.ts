...
export class migr11632747688601 implements MigrationInterface {
    name = 'migr11632747688601'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "isFortyTwoAccount" boolean NOT NULL DEFAULT false, "twoFactorAuthenticationSecret" character varying, "isTwoFactorAuthenticationEnabled" boolean NOT NULL DEFAULT false, "avatar" character varying NOT NULL DEFAULT 'http://localhost:3000/user/avatar/default', "status" integer NOT NULL DEFAULT '0', "level" integer NOT NULL DEFAULT '0', "nGames" integer NOT NULL DEFAULT '0', "nWins" integer NOT NULL DEFAULT '0', "nLosses" integer NOT NULL DEFAULT '0', "xp" integer NOT NULL DEFAULT '0', "admin" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_065d4d8f3b5adb4a08841eae3c8" UNIQUE ("name"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
